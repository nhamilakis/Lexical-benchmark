...
def parseArgs(argv):
    ...
    parser.add_argument('--threshold', type=float, default=0.05,
                        help='difference threshold of each bin')
...
def plot_all_histogram(freq, num_bins, freq_type, lang, eval_condition, freqPath, match_mode, eval_type, threshold,
    ...
    stat_audiobook = plot_density_hist(freq, 'Audiobook_' + freq_type, freq_type, 'Audiobook', alpha, 'equal_bins',
                                       num_bins)
...
def main(argv):
    ...
    freq_path = args.freqPath + 'freq/' + args.word_format + '/' + args.match_mode + '/' + str(
        args.num_bins) + '/' + str(args.threshold) + '/'
    ...
    compare_histogram(matched_CDI, matched_audiobook, args.num_bins, args.freq_type, args.lang, args.eval_condition,
                      fig_path, args.match_mode, args.threshold, alpha=0.5)

    stat_CDI = plot_all_histogram(matched_CDI, args.num_bins, args.freq_type, args.lang, args.eval_condition, fig_path,
                                  args.match_mode, 'CDI', args.threshold, alpha=0.5)
    stat_matched = plot_all_histogram(matched_audiobook, args.num_bins, args.freq_type, args.lang, args.eval_condition,
