...
def parseArgs(argv):
    ...
    parser.add_argument('--month', type=str, default = '1600',
    ...
    parser.add_argument('--DataPath', type=str, default = 'eval/Prompt_AE.csv',
    ...
    parser.add_argument('--prompt_mode', type=str, default = 'prompted',
    ...
    parser.add_argument('--sample_lst', default = '0.8',
                        help='a list of top-k or top_p or beam candidates')
    
    parser.add_argument('--temp_lst', default = '0.5',
