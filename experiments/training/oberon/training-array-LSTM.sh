...
FILENAME="${DATASET_ROOT}/script_arg/LSTM_train-args.index"
...
echo "Running Training of LSTM Model  ($SLURM_ARRAY_JOB_ID/$SLURM_ARRAY_TASK_ID) @ $(date)"
...
python "$CODE/Lexical_benchmark/src/scripts/train/hf/train_LSTM.py" \
