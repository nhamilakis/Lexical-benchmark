...
from lexical_benchmark.gen.generate import *
...
def parseArgs(argv):
    ...
    parser.add_argument('--SAVE_INTERVAL', default=2,
                        help='The number of rows to save')
...
def main(argv):
    ...
    #model_path = str(Path(args.model_path).resolve())    # test the symlink
