# -*- coding: utf-8 -*-
"""
get freq of CDI receptive/expressive vocab from CHILDES children's utterances and also fitness between accumulator and CDI data
...
def main(argv):
    ...
    for threshold in threshold_range:
            ...
            if not os.path.exists(chunk_path):   
                ...
                print('Finished counting by month')
